...
function ExpressKomp({ toggleHover, isHoverEs }) {
  return (
    <div
      onMouseEnter={() => toggleHover("es")}
      onMouseLeave={() => toggleHover("es")}
    ...
    >
      <svg
        ...
        className="md:w-[56px] md:h-[56px] w-[45px] h-[45px] "
      >
        <g clipPath="url(#clip0_196_516)">
          <path
