...
function NodeJsKomp({ toggleHover, isHoverNj }) {
  return (
    <div
      onMouseEnter={() => toggleHover("nj")}
      onMouseLeave={() => toggleHover("nj")}
    ...
    >
      <svg
        ...
        className="md:w-[56px] md:h-[56px] w-[45px] h-[45px] transition-all duration-700"
      >
